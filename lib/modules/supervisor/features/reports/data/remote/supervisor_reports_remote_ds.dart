...
class SupervisorReportsRemoteDs {
  ...
  Future<(ReportModel, List<String>)> sendToUnit({
    ...
    try {
      ...
      debugPrint('[SupervisorReportsRemoteDs.sendToUnit] failed: $e\n$st');
  ...
  Future<(ReportModel, List<String>)> broadcast({
    ...
    try {
      ...
      final unitIds =
          (unitsData as List).map((e) => e['id'] as String).toList();
      ...
      debugPrint('[SupervisorReportsRemoteDs.broadcast] failed: $e\n$st');
      throw SupabaseErrorHandler.handle(e);
    }
  }
  ...
  Future<(ReportModel, List<String>)> forwardToAdmin({
    ...
    try {
      ...
      debugPrint('[SupervisorReportsRemoteDs.forwardToAdmin] failed: $e\n$st');
      throw SupabaseErrorHandler.handle(e);
    }
  }
