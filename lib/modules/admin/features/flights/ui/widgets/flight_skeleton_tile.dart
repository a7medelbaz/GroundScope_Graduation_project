...
class FlightSkeletonTile extends StatelessWidget {
  const FlightSkeletonTile({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          _Bone(width: rw(44), height: rh(44), radius: rr(12)),
          horizontalSpacing(12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _Bone(width: rw(100), height: rh(14), radius: rr(4)),
                verticalSpacing(6),
                _Bone(width: double.infinity, height: rh(11), radius: rr(4)),
                verticalSpacing(6),
                _Bone(width: rw(80), height: rh(11), radius: rr(4)),
              ],
            ),
          ),
          horizontalSpacing(12),
          _Bone(width: rw(60), height: rh(24), radius: rr(14)),
        ],
      ),
    )
