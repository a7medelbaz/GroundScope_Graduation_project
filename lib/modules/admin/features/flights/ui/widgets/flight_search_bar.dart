...
class FlightSearchBar extends StatelessWidget {
  const FlightSearchBar({super.key, required this.onChanged, this.controller});
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        contentPadding: EdgeInsets.symmetric(horizontal: rw(16), vertical: rh(12)),
