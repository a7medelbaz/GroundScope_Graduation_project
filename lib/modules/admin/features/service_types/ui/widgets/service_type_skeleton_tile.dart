...
class ServiceTypeSkeletonTile extends StatelessWidget {
  const ServiceTypeSkeletonTile({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          _Bone(width: rw(44), height: rw(44), radius: rr(12)),
          horizontalSpacing(12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _Bone(width: double.infinity, height: rh(14), radius: rr(4)),
                verticalSpacing(8),
                _Bone(width: rw(120), height: rh(11), radius: rr(4)),
              ],
            ),
          ),
          horizontalSpacing(12),
